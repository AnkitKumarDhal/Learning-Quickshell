...
FocusScope {
     ...
     * Maximum menu height.
     *
     * Menus can be smaller than this, but never larger.
     */
    ...
    /*
     * The submenu that belongs to this level.
     */
    ...
    /*
     * Which real menu entry is currently keyboard-selected.
     *
     * This is the actual children-model index, not the position among
     * selectable entries.
     */
    ...
    /*
     * Emitted when the pointer enters any item in this level.
     *
     * The parent level uses this to cancel its submenu-close grace timer.
     */
    signal pointerEntered()

    /*
     * Calculate the natural height of all menu entries before scrolling.
     */
    ...
    /*
     * Called when pointer navigation should preserve the currently open
     * submenu while the cursor travels through the gap between menu levels.
     */
     ...
     * Scrollbar thumb.
     *
     * It is intentionally tiny and unobtrusive. There is no scrollbar track
     * because the menu itself communicates scrolling through clipping and
     * mouse-wheel support.
     */
    Rectangle {
        id: scrollHandle
        visible:
            contentFlick.contentHeight >
            contentFlick.height
    ...
    Loader {
        ...
        onLoaded: {
            ...
            item.pointerEntered.connect(
                root.cancelSubmenuClose
            )
    ...
    Keys.onPressed: (event) => {
        ...
        case Qt.Key_Right:
            if (
                ...
                if (
                    entries[root.currentIndex] &&
                    entries[root.currentIndex].hasChildren
                ) {
                    root.openSubmenu(
                        root.currentIndex,
                        true
    ...
    /*
     * Parent menu reference used for keyboard Left-arrow navigation.
     */
